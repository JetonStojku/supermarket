    ...
    def unlink(self):
        for fature in self:
            ...
            for obj in fature.shporta_ids:
                for produkt in obj.produkti.magazinat_ids:
                    if produkt.magazine_id == obj.magazina_id:
                        produkt.sasia += obj.sasia
            ...
            return super(Fatura, fature.with_context(ctx)).unlink()
